...
```$xslt
go get github.com/kswlee/kryptology
```

Pin a specific release of this library:
```$xslt
go get github.com/kswlee/kryptology@v1.6.0
```

## Documentation

Public documentations can be found at https://pkg.go.dev/github.com/kswlee/kryptology

To access the documentation of the local version, run `godoc -http=:6060` and open
the following url in your browser.

http://localhost:6060/pkg/github.com/kswlee/kryptology/

## Developer Setup
**Prerequisites**: `golang 1.17`, `make`

```$xslt
git clone git@github.com/kswlee/kryptology.git && make 
``` 
